  ...
  return docInfo && (
    <div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointment} className='bg-primary text-white text-sm font-light py-3 px-14 rounded-full my-6 cursor-pointer'>Book an appointment</button>
      </div>
